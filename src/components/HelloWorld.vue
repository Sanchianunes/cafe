<template>
  <div class="hello">
    <div id="app-cover">
      <div class="row">
        <TableButton
          v-for="(table, index) in [1, 2, 3, 4, 5, 6, 7, 8, 23, 4, 6]"
          :key="`table-${index}`"
        />
      ...
      <div class="row">
        ...
        <div class="toggle-button-cover">
          <div class="button-cover">
            <div id="button-6" class="button r">
              <input type="checkbox" class="checkbox" />
              <div class="knobs"></div>
              <div class="layer"></div>
            </div>
      ...
      <div class="row">
        <div class="toggle-button-cover">
          <div class="button-cover">
            <div id="button-7" class="button r">
              <input type="checkbox" class="checkbox" />
              <div class="knobs">
                <span></span>
              </div>
        ...
        <div class="toggle-button-cover">
          <div class="button-cover">
            <div id="button-8" class="button r">
              <input type="checkbox" class="checkbox" />
              <div class="knobs">
                <span></span>
              </div>
        ...
        <div class="toggle-button-cover">
          <div class="button-cover">
            <div id="button-9" class="button r">
              <input type="checkbox" class="checkbox" />
              <div class="knobs">
                <span></span>
              </div>
      ...
      <div class="row">
        <div class="toggle-button-cover">
          <div class="button-cover">
            <div id="button-10" class="button b2">
              <input type="checkbox" class="checkbox" />
              <div class="knobs">
                <span>YES</span>
              </div>
        ...
        <div class="toggle-button-cover">
          <div class="button-cover">
            <div id="button-11" class="button b2">
              <input type="checkbox" class="checkbox" />
              <div class="knobs">
                <span></span>
              </div>
        ...
        <div class="toggle-button-cover">
          <div class="button-cover">
            <div id="button-12" class="button b2">
              <input type="checkbox" class="checkbox" />
              <div class="knobs">
                <span></span>
              </div>
      ...
      <div class="row">
        <div class="toggle-button-cover">
          <div class="button-cover">
            <div id="button-13" class="button b2">
              <input type="checkbox" class="checkbox" />
              <div class="knobs">
                <span></span>
              </div>
        ...
        <div class="toggle-button-cover">
          <div class="button-cover">
            <div id="button-14" class="button b2">
              <input type="checkbox" class="checkbox" />
              <div class="knobs">
                <span></span>
              </div>
        ...
        <div class="toggle-button-cover">
          <div class="button-cover">
            <div id="button-15" class="button b2">
              <input type="checkbox" class="checkbox" />
              <div class="knobs"></div>
              <div class="layer"></div>
            </div>
      ...
      <div class="row">
        <div class="toggle-button-cover">
          <div class="button-cover">
            <div id="button-16" class="button b2">
              <input type="checkbox" class="checkbox" />
              <div class="knobs"></div>
              <div class="layer"></div>
            </div>
        ...
        <div class="toggle-button-cover">
          <div class="button-cover">
            <div id="button-17" class="button b2">
              <input type="checkbox" class="checkbox" />
              <div class="knobs">
                <span></span>
              </div>
